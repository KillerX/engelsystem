...
class ImportUsersCotroller extends BaseController
{
    ...
    /** @var array */
    protected $permissions = ["admin_user"];
    ...
    {
        return $this->response->withView("admin/user/import.twig", [
            "created" => false,
            "userCount" => "",
    ...
    public function process(Request $request): Response
    {
        ...
        DB::update(
            DB::raw(
                "UPDATE UserAngelTypes SET confirm_user_id = 1 WHERE user_id IN (" . implode(",", $newUserIDs) . ");"
            )
        );
